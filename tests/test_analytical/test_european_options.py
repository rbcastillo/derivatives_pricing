...
class TestSpecial(unittest.TestCase):
    ...
    def test_string_casting_call(self):
    ...
    def test_string_casting_put(self):
        parameters = {'s': 100, 'k': 120, 'r': 0.05, 't': 5, 'sigma': 0.2, 'q': 0.02}
    ...
    def test_add_new_param_generic_put(self):
        put = EuropeanPut(s=100, k=120, r=0.05, t=5, sigma=0.2, q=0.02)
        try:
            put.not_existent = 5
            self.assertTrue(False)
    ...
    def test_add_new_param_method_call(self):
        call = EuropeanCall(s=100, k=120, r=0.05, t=5, sigma=0.2, q=0.02)
        try:
    ...
    def test_add_new_param_method_put(self):
        put = EuropeanPut(s=100, k=120, r=0.05, t=5, sigma=0.2, q=0.02)
        try:
    ...
    def test_change_existing_param_forbidden_generic_call(self):
        call = EuropeanCall(s=100, k=120, r=0.05, t=5, sigma=0.2, q=0.02)
        try:
            call._d1 = 5
            self.assertTrue(False)
    ...
    def test_change_existing_param_forbidden_generic_put(self):
        put = EuropeanPut(s=100, k=120, r=0.05, t=5, sigma=0.2, q=0.02)
        try:
            put._d1 = 5
            self.assertTrue(False)
    ...
    def test_change_existing_param_forbidden_method_call(self):
        call = EuropeanCall(s=100, k=120, r=0.05, t=5, sigma=0.2, q=0.02)
        try:
    ...
    def test_change_existing_param_forbidden_method_put(self):
        put = EuropeanPut(s=100, k=120, r=0.05, t=5, sigma=0.2, q=0.02)
        try:
